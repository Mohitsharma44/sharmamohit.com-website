%-------------------------
% OpenAI-tailored Resume in LaTeX
% Author  : Mohit Sharma
% License : MIT
%------------------------
...
Infrastructure and distributed-systems engineer with 12+ years designing, building, and operating foundational platforms across Kubernetes, AWS, Linux, and cloud infrastructure. I lead ambiguous, cross-functional initiatives from architecture through production, with a focus on scalable cloud abstractions, reliability, security, and developer self-service. I build infrastructure that reduces operational complexity, raises the reliability and security bar, and lets engineering teams ship faster without becoming infrastructure experts.

\section{\color[HTML]{DF691A} Skills}
\small{
\textbf{Languages:} Go, Python, Bash \\
\textbf{Distributed Systems \& Platform:} Kubernetes, Kubernetes controllers, Linux, Helm, ArgoCD, Flux, Backstage \\
\textbf{Cloud \& Infrastructure:} AWS, GCP, Terraform, Ansible, Packer, multi-account and multi-region deployments \\
\textbf{Reliability \& Observability:} Prometheus, Grafana, OpenTelemetry, ELK, production incident response \\
...
\resumeItemListStart
\resumeItem{Developer platform architecture}
...
\resumeItemListStart
\resumeItem{Cloud deployment platform}
...
\resumeItem{Cloud and Kubernetes infrastructure}
