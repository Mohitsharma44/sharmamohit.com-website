%-------------------------
% Nango-tailored Resume in LaTeX
% Author  : Mohit Sharma
% License : MIT
%------------------------
...
Staff-level platform and infrastructure engineer with 12+ years designing, scaling, and operating distributed systems across Kubernetes, AWS, Linux, and cloud platforms. I lead high-ownership initiatives spanning platform architecture, reliability, security, multi-region infrastructure, and developer self-service. I build durable abstractions and operational systems that reduce incident load, improve engineering velocity, and help small teams operate complex infrastructure safely at scale.

\section{\color[HTML]{DF691A} Skills}
\small{
\textbf{Languages:} Go, Python, Bash \\
\textbf{Cloud \& Platform:} AWS, GCP, Kubernetes, EKS, ECS, Helm, ArgoCD, Flux, Backstage \\
\textbf{Infrastructure as Code:} Terraform, Ansible, Packer \\
\textbf{Data \& Distributed Systems:} RDS/Aurora PostgreSQL, Kafka/MSK, Redis, S3, distributed service architectures \\
\textbf{Reliability \& Security:} Prometheus, Grafana, OpenTelemetry, ELK, incident response, Vault, SPIRE, OPA, mTLS
}
...
{Co-leading technical direction for the internal developer platform, owning the developer-experience and self-service roadmap and shaping foundational capabilities that help engineering teams provision, deploy, and operate services more reliably and safely.}
\resumeItem{Distributed-systems reliability}
...
\resumeItem{Infrastructure security}
...
\resumeItem{Autonomous infrastructure workflows}
...
\resumeItem{Shared control-plane evaluation}
...
{Authored RFCs and technical one-pagers that steered cross-team platform and infrastructure decisions, mentored engineers through design and ownership transitions, and drove durable engineering standards across teams.}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Self-service cloud platform}
{Built foundational components of the Angi One platform using Kubernetes controllers, Flux, and ArgoCD, enabling developers to provision applications and cloud services from a single declarative manifest and cutting production delivery time by 50\%.}
\resumeItem{Platform automation}
{Partnered with application and observability teams to automate Backstage catalog component generation and improve service onboarding, discoverability, and system visibility across the engineering organization.}
\resumeItem{Declarative tooling}
...
\resumeItemListStart
\resumeItem{Multi-account and multi-region AWS}
{Designed an automated deployment platform for microservices across AWS accounts and regions, standardizing service delivery and reducing recurring operations toil by more than four hours per week.}
