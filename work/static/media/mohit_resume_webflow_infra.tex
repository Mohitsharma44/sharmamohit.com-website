%-------------------------
% Webflow Infrastructure-tailored Resume in LaTeX
% Author  : Mohit Sharma
% License : MIT
%------------------------
...
Staff-level infrastructure and reliability engineer with 12+ years designing, scaling, and operating distributed systems across Kubernetes, AWS, Linux, and cloud platforms. I lead cross-functional initiatives spanning multi-region infrastructure, platform automation, production reliability, security, and developer self-service. I build durable cloud foundations and operational tooling that reduce incident load, improve engineering speed and safety, and help teams ship reliably at scale.
...
\resumeItem{Internal platform architecture}
...
\resumeItem{Agentic infrastructure workflows}
...
{Authored RFCs and technical one-pagers that steered cross-team platform and infrastructure decisions, mentored engineers through design and ownership transitions, and taught engineers across the organization to build reusable AI-assisted developer tooling.}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Cloud platform abstractions}
...
\resumeItemListStart
\resumeItem{Multi-region cloud infrastructure}
...
\resumeItem{Cross-team leadership}
